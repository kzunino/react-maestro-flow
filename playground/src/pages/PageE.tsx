...
export default function PageE() {
	...
	const [premiumFeature, setPremiumFeature] =
		stateKey<string>("premiumFeature");
	...
	return (
		<PageLayout>
			...
			<p className="text-muted-foreground">
				Welcome, premium user! ({email}) This is a special page only for premium
				users.
			</p>
			...
			<div className="mt-4 p-4 bg-muted rounded-md">
				...
				<p className="text-sm text-muted-foreground mt-2">
					This page is only accessible to premium users. Both branches converge
					on Page D.
				</p>
			</div>
		</PageLayout>
